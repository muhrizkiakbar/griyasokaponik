    ...
    return (
        <AppLayout title="Dashboard">
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 xl:grid-cols-3">
                <div className="rounded-3xl border border-green-100 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#123D2A] xl:col-span-1">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-gray-500 dark:text-green-100">
                                Keuangan Bulan Ini
                            </p>
                            <h2 className="mt-1 text-xl font-bold text-green-950 dark:text-white">
                                Ringkasan Laba Rugi
                            </h2>
                        </div>
            ...
            <div className="mt-8 rounded-3xl border border-green-100 bg-green-50 p-6 shadow-sm dark:border-white/10 dark:bg-[#0B2A1E]">
                <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-green-700 shadow-sm dark:bg-white/10 dark:text-lime-400">
...
function StatCard({ title, value, description, icon: Icon }) {
    return (
        <div className="group overflow-hidden rounded-3xl border border-green-100 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-white/10 dark:bg-[#123D2A]">
            <div className="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p className="mt-3 text-3xl font-extrabold text-green-950 dark:text-white">
                        {value}
                    </p>
                ...
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-lime-100 text-green-700 transition group-hover:bg-lime-400 group-hover:text-green-950 dark:bg-lime-400 dark:text-green-950">
...
function FinanceRow({ label, value, icon: Icon, type }) {
    ...
    return (
        <div className="flex items-center justify-between rounded-2xl border border-green-100 bg-green-50 p-4 dark:border-white/10 dark:bg-[#0B2A1E]">
            <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white text-green-700 dark:bg-white/10 dark:text-lime-400">
                ...
                <div>
                    ...
                    <p className="text-lg font-bold text-green-950 dark:text-white">
...
function HarvestScheduleCard({
    ...
    return (
        <div className="rounded-3xl border border-green-100 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#123D2A]">
            <div className="flex items-center justify-between">
                <div>
                    <p className="text-sm font-medium text-gray-500 dark:text-green-100">
                        {description}
            ...
            <div className="mt-6">
                {items.length === 0 ? (
                    <div className="rounded-2xl border border-dashed border-green-200 bg-green-50 p-5 text-center dark:border-white/10 dark:bg-white/5">
                        <p className="text-sm font-medium text-gray-500 dark:text-green-100">
                            {emptyText}
                        </p>
                    </div>
                    ...
                    <div className="space-y-3">
                        {items.map((batch) => (
                            <div
                                key={batch.id}
                                className="flex items-center justify-between gap-4 rounded-2xl border border-green-100 bg-green-50 px-4 py-3 dark:border-white/10 dark:bg-[#0B2A1E]"
                            >
                                <div>
