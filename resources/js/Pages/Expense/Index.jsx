                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-500 dark:text-green-100">
                                Catatan biaya operasional kebun, perawatan, bibit, alat, dan kebutuhan produksi.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid gap-3 md:grid-cols-12">
                        <div className="relative md:col-span-7">
                            ...
                            <input
                                ...
                                placeholder="Cari tanggal, deskripsi, jumlah, atau bukti transaksi..."
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            <span className="inline-flex items-center gap-2 rounded-full bg-green-100 px-3 py-1 text-xs font-semibold text-green-700 dark:bg-lime-400 dark:text-green-950">
                                                ...
                                                {exp.category?.name || exp.category?.category_name || '-'}
                                            </span>
                                        </TableCell>
                                        ...
                                        <TableCell align="right">
                                            <div className="flex justify-end gap-2">
                                                ...
                                                <Link
                                                    href={route('expenses.destroy', exp.id)}
                                                    method="delete"
                                                    as="button"
...
function EmptyState({ compact = false, search = '', expenseCategoryId = '' }) {
    const hasFilter = search || expenseCategoryId;
    ...
    return (
        <div className="mx-auto flex max-w-sm flex-col items-center">
            ...
            <p className="mt-3 font-semibold text-green-950 dark:text-white">
                {hasFilter ? 'Pengeluaran tidak ditemukan' : 'Belum ada pengeluaran'}
            </p>
            ...
            {!compact && (
                <p className="mt-1 text-sm text-gray-500 dark:text-green-100">
                    {hasFilter
                        ...
                        : 'Tambahkan pengeluaran pertama untuk menghitung biaya operasional kebun.'}
                </p>
            )}
        </div>
    );
