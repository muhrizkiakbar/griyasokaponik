                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-green-950 dark:text-white">
                                {isEdit ? 'Edit Bedengan' : 'Tambah Bedengan'}
                            </h2>
                            <p className="mt-1 text-sm text-gray-500 dark:text-green-100">
                                Kelola bedengan, meja tanam, rak semai, atau instalasi hidroponik.
                            </p>
                        </div>
                    </div>

                    <Link
                        href={route('growing-units.index')}
                ...
                >
                    <div className="border-b border-green-100 bg-green-50 px-6 py-5 dark:border-white/10 dark:bg-white/10">
                        <h3 className="text-lg font-bold text-green-950 dark:text-white">
                            Informasi Unit Tanam
                        </h3>
                        <p className="mt-1 text-sm text-gray-500 dark:text-green-100">
                            Data ini digunakan untuk alokasi batch semai dan pemantauan kapasitas tanam.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-6 p-6 md:grid-cols-2">
                        <FormSelect
                            ...
                            error={errors.growing_area_id}
                            required
                            icon={MapIcon}
                            onChange={(value) => setData('growing_area_id', value)}
                            options={[
                        ...
                        <FormInput
                            ...
                            required
                            icon={HashtagIcon}
                            placeholder="Contoh: NFT-01"
                            onChange={(value) => setData('unit_code', value)}
                        />
                        ...
                        <FormInput
                            ...
                            required
                            icon={Squares2X2Icon}
                            placeholder="Contoh: NFT Jalur 1"
                        ...
                        <FormInput
                            ...
                            required
                            icon={TagIcon}
                            placeholder="Contoh: Bedengan / NFT / Rak Semai"
                            onChange={(value) => setData('unit_type', value)}
                        />
